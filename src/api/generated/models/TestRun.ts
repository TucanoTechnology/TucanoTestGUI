...
/**
 * A point-in-time snapshot of the suites, cases and results a run recorded. The snapshot embeds a copy of each referenced document, so a later edit to the source leaves the run unchanged.
 */
export type TestRun = {
  testRunId: string;
  /**
